...
namespace VisProcess.Controllers
{
    ...
    [Route("api/FTPs")]
    [ApiController]
    public class DeleteDirUSController : ControllerBase
    {
        ...
        public DeleteDirUSController(IConfiguration configuration,UnitWork unitWork)
        {
        ...
        {
            host = _configuration.GetSection("DeleteDirectory").GetValue<string>("DeleteDirUSHost");//ConfigurationManager.AppSettings["DeleteDirUSHost"];
            user = _configuration.GetSection("DeleteDirectory").GetValue<string>("DeleteDirUSUser");//ConfigurationManager.AppSettings["DeleteDirUSUser"];
            pass = _configuration.GetSection("DeleteDirectory").GetValue<string>("DeleteDirUSPass");//ConfigurationManager.AppSettings["DeleteDirUSPass"];
            //string tmppath = "";
            ...
            foreach (var jobs in JobsTobeDeleted)
            {
                if (jobs.FileUploadPath != null)
                {
                    ...
                    string[] year = clientpath.Split(new char[] { '/' });
                    string PathQuarter = String.Join("/", year, 0, 1);
                    if (PathQuarter == "ClientOrders")
                    {
            ...
            foreach (var item in JobsTobeDeleted)
            {
                ...
                //string path = "PRAS/05-19-2018/1205 2018-VLA-Fr-0512-13342/Client Coordination/Pending-1";//sample
        ...
        public void DeleteFile(string deleteFile)
        {
            ...
            {
                //throw ex;
                StreamWriter sw = new StreamWriter(_configuration.GetSection("DeleteDirectory").GetValue<string>("ServiceLogPath")/*ConfigurationManager.AppSettings["ServiceLogPath"]*/ + "DeleteDirUSLogE.txt", true);
                sw.WriteLine(ex);
